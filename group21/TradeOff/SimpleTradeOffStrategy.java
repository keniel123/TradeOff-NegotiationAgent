...
public class SimpleTradeOffStrategy {
    ...
    private static final double UTILITY_DEVIATION = .03D;
    private static final double SIMILARITY_THRESHOLD = .900D;
    private static final double SIMILARITY_DEVIATION = .010;
